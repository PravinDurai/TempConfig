			...
			<xsl:otherwise>
				<xsl:choose>							
					<xsl:when test="$Exceptions = 'PolicyException'">
						<ns0:PurchasePolicyFault xmlns:ns0 = "http://www.vodafone.com/vf/contentSellingManagement/interface/v.1.1" xmlns:ns1 = "http://xmlns.vodafone.co.uk/RIG/common/Fault">
							<ns1:faultCode>
								<xsl:value-of select="$faultCode"/>
							</ns1:faultCode>
							<ns1:faultString>
						...
						</ns0:PurchasePolicyFault>
					</xsl:when>
					<xsl:otherwise>
						<ns0:PurchaseServiceFault xmlns:ns0 = "http://www.vodafone.com/vf/contentSellingManagement/interface/v.1.1" xmlns:ns1 = "http://xmlns.vodafone.co.uk/RIG/common/Fault">
							<ns1:faultCode>
								<xsl:value-of select="$faultCode"/>
							</ns1:faultCode>
							<ns1:faultString>
