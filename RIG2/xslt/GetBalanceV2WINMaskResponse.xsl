...
xmlns:ns0="http://xmlns.vodafone.co.uk/map/til/Billing/BalanceManagement/DebitCreditManagement/GetBalance"
...
xmlns:ns2="http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/CustomerParty/V2"
...
<xsl:copy-of select="codecs:base64ToText($JMSResponse/h:body)"/>
   ...
   <xsl:variable name="sbResponse">
	...
	<xsl:template match="ns0:GetBalanceResponse/ns0:QueryCustomerPartyResponse/ns2:QueryCustomerPartyListResponse/ns2:CustomerPartyBillingProfile/ns2:BalanceGroup/ns2:ResourceUnit/ns2:CreditLimitRange/ns2:Custom"/>
	<xsl:template match="ns0:GetBalanceResponse/ns0:QueryCustomerPartyResponse/ns2:QueryCustomerPartyListResponse/ns2:CustomerPartyBillingProfile/ns2:BalanceGroup/ns2:ResourceUnit/ns2:Custom/ns3:CarriedOverQuantity"/>
</xsl:stylesheet>