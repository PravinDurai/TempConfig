...
<xsl:stylesheet version="1.0" 
	...
	<xsl:variable name="IdentityID">
		<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:identityID"/>
	</xsl:variable>
	...
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="$IdentityID='VFUKTIL'">
				<xsl:choose>
					<xsl:when test="$sbResponse/er-response[@id='100001']">
						<v:UsageAuthRateChargeServiceFault  xmlns:ns1 = "http://xmlns.vodafone.co.uk/RIG/common/Fault">
            ...
            , error@system-id - <xsl:value-of select="$sbResponse/er-response/payload/error/attribute::system-id"/>
						...
						</v:UsageAuthRateChargeServiceFault>
					</xsl:when>
					<xsl:when test="$sbResponse/er-response[@id='100008']">
						<v:UsageAuthRateChargeResponse>
							<v1:er-response>
							...
							<v1:traceIdentifier>
								<v2:applicationID>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:applicationID"/>
								</v2:applicationID>
								<v2:serviceID>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:serviceID"/>
								</v2:serviceID>
								<v2:serviceInterfaceVersion>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:serviceInterfaceVersion"/>
								</v2:serviceInterfaceVersion>
								<v2:timestamp>
									<xsl:value-of select="current-dateTime()"/>
								</v2:timestamp>
								<v2:referenceID>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:referenceID"/>
								</v2:referenceID>
								<v2:correlationID>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:correlationID"/>
								</v2:correlationID>
								<v2:identityID>
									<xsl:value-of select="$context/v:UsageAuthRateCharge/v1:traceIdentifier/v2:identityID"/>
								</v2:identityID>
					...
					<xsl:otherwise>
						<v:UsageAuthRateChargeResponse>
							<v1:er-response>
								...
								<v1:purchase-options>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/reason-code">
												<v1:reason-code><xsl:copy-of select="$sbResponse/er-response/payload/purchase-options/reason-code/*"/></v1:reason-code>
											</xsl:if>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/sub-reason-code">
												<v1:sub-reason-code><xsl:copy-of select="$sbResponse/er-response/payload/purchase-options/sub-reason-code/*"/></v1:sub-reason-code>													</xsl:if>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/super-credit-balances">
												<v1:super-credit-balances><xsl:copy-of select="$sbResponse/er-response/payload/purchase-options/super-credit-balances/*"/></v1:super-credit-balances>										</xsl:if>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/packages/package">
												<v1:packages><v1:package><xsl:copy-of select="$sbResponse/er-response/payload/purchase-options/packages/package/*"/></v1:package></v1:packages>									</xsl:if>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/has-promotions">
												<v1:has-promotions><xsl:value-of select="$sbResponse/er-response/payload/purchase-options/has-promotions"/></v1:has-promotions>													</xsl:if>
											<xsl:if test="$sbResponse/er-response/payload/purchase-options/promotional-packages">
												<v1:promotional-packages><xsl:copy-of select="$sbResponse/er-response/payload/purchase-options/promotional-packages/*"/></v1:promotional-packages>										</xsl:if>
								</v1:purchase-options>
							</v1:er-response>
							<v1:traceIdentifier>
								<v2:applicationID>
