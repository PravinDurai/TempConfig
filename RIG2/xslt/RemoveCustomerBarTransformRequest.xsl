	...
	<xsl:template match="/">
		<details>
			...
			<BusinessKey>
				<Name>MSISDN</Name>
				<Value>
					<xsl:value-of select="$cnRequest/SOAP-ENV:Envelope/SOAP-ENV:Body/v:RemoveCustomerBar/v1:CTN"/>
				</Value>
			</BusinessKey>
			<RequestPayload>
			...
			<TargetOperation>RemoveCustomerBar</TargetOperation>
		</details>
	</xsl:template>
</xsl:stylesheet>