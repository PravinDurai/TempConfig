...
xmlns:ns0="http://xmlns.vodafone.co.uk/map/til/CustomerManagement/CustomerProfileManagement/CustomerIdentityManagement/GetTerminalLocation"
xmlns:ns1="http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/Device/V1"
xmlns:ns3="http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/EBO/Location/V1"
...
<xsl:copy-of select="codecs:base64ToText($JMSResponse/h:body)"/>
 ...
 <xsl:template match="ns0:GetTerminalLocationResponse/ns0:Device"/>
 <xsl:template match="ns0:GetTerminalLocationResponse/ns0:Location/ns2:GeographicalCoordinate/ns2:AltitudeMeasure"/>
 <xsl:template match="ns0:GetTerminalLocationResponse/ns0:LocationCharacteristics/ns3:PSISAIIndicator"/>
