...
<xsl:variable name="soapaction">
  <xsl:value-of select="$context/c:context/c:entry[@key='asg:httpRequest']/h:request/h:header[@name='SoapAction']"/>
</xsl:variable>
<xsl:template match="/">
