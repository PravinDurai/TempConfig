			...
			<xsl:otherwise>
				<xsl:choose>							
					<xsl:when test="$Exceptions = 'PolicyException'">
						<ns0:GetLatLongPolicyFault xmlns:ns0 = "http://www.vodafone.com/vf/locationInformation/interface/v.1.1" xmlns:ns1 = "http://xmlns.vodafone.co.uk/RIG/common/Fault">
							<ns1:faultCode>
								<xsl:value-of select="$faultCode"/>
							</ns1:faultCode>
							<ns1:faultString>
						...
						</ns0:GetLatLongPolicyFault>
					</xsl:when>
					<xsl:otherwise>
						<ns0:GetLatLongServiceFault xmlns:ns0 = "http://www.vodafone.com/vf/locationInformation/interface/v.1.1" xmlns:ns1 = "http://xmlns.vodafone.co.uk/RIG/common/Fault">
							<ns1:faultCode>
								<xsl:value-of select="$faultCode"/>
							</ns1:faultCode>
							<ns1:faultString>
