...
<xsl:stylesheet version="1.0" xmlns:ns1="http://www.vodafone.com/rig/internal/validateheader/v1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:v="http://www.vodafone.com/vf/customerPersonalInformationManagement/interface/v.2.1" xmlns:v1="http://www.vodafone.com/vf/customerPersonalInformationManagement/messages/v.2.1" xmlns:v2="http://www.vodafone.com/vf/core_common/types/v.0.3/"
xmlns:asg_map="http://www.tibco.com/asg/mapping" xmlns:err="http://www.tibco.com/schemas/asg/error" xmlns:c="http://www.tibco.com/schemas/asg/context" xmlns:h="http://www.tibco.com/asg/protocols/http" xmlns:asg="http://www.tibco.com/asg/error">
	...
	<xsl:template match="/">
		<ns0:GetCustomerDetailsRequest xmlns:ns0 = "http://xmlns.vodafone.co.uk/map/til/CustomerManagement/CustomerContactManagement/CustomerDataPresentation/GetCustomerDetails">
			<ns0:accountID>
				<xsl:value-of select="$cnRequest/SOAP-ENV:Envelope/SOAP-ENV:Body/v:GetCustomerDetails/v1:accountID"/>
			</ns0:accountID>
