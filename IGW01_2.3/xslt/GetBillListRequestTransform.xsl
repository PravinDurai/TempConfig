...
<xsl:stylesheet xmlns:head="http://xmlns.vodafone.co.uk/map/til/wsdl/Common/Header" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:ns1="http://www.vodafone.com/rig/internal/validateheader/v1.0" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:req="http://xmlns.vodafone.co.uk/map/til/wsdl/Common/RequestHeader" xmlns:log="http://xmlns.vodafone.co.uk/map/til/Common/CommonObjects/Logon" xmlns:get="http://xmlns.vodafone.co.uk/map/til/Billing/CustomerBillProduction/GetBillList" xmlns:v2="http://www.vodafone.com/vf/core_common/types/v.0.3/" xmlns:asg_map="http://www.tibco.com/asg/mapping" xmlns:err="http://www.tibco.com/schemas/asg/error" xmlns:c="http://www.tibco.com/schemas/asg/context" xmlns:h="http://www.tibco.com/asg/protocols/http" xmlns:asg="http://www.tibco.com/asg/error">
	...
	<xsl:template match="/">
		<get:GetBillListRequest xmlns="http://xmlns.vodafone.co.uk/map/til/Billing/CustomerBillProduction/GetBillList">
			<xsl:copy-of select="$cnRequest/soapenv:Envelope/soapenv:Body/get:GetBillListRequest/*"/>
		</get:GetBillListRequest>
	</xsl:template>
</xsl:stylesheet>